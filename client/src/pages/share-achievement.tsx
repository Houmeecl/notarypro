...
import SocialShareButtonHelper from '@/components/micro-interactions/SocialShareButtonHelper';
import { useToast } from '@/hooks/use-toast';
import { Link } from 'wouter';
import logo from '@assets/logo12582620.png';

// Utilizamos el componente SocialShareButtonHelper ya importado
            ...
            <div className="bg-gray-50 dark:bg-gray-800/50 p-4 rounded-lg">
              ...
              <div className="grid grid-cols-3 sm:grid-cols-6 gap-2">
                ...
                <SocialShareButtonHelper 
                  network="facebook" 
                  shareUrl={window.location.href}
                  quote={`¡Mira este logro "${achievement?.name}" en Cerfidoc! Plataforma líder de verificación de documentos digitales en Chile.`}
                  icon={
                    <svg className="h-5 w-5" viewBox="0 0 24 24" fill="currentColor">
