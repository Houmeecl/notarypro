...
exports.convertPresentialToRemote = convertPresentialToRemote;
exports.identifyPresentialTerms = identifyPresentialTerms;
exports.generateConversionReport = generateConversionReport;
exports.documentRequiresConversion = documentRequiresConversion;
// Mapeo de términos presenciales a sus equivalentes remotos
const PRESENTIAL_TO_REMOTE_TERMS = {
    // Términos generales
    'presencial': 'remoto',
 ...
 */
function convertPresentialToRemote(text) {
 ...
 */
function identifyPresentialTerms(text) {
    const foundTerms = [];
 ...
 */
function generateConversionReport(text) {
    const termCounts = {};
 ...
 */
function documentRequiresConversion(text) {
