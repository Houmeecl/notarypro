 ...
 */
function generateVerificationCode(documentId, title) {
    // Generar un código aleatorio de 8 caracteres con nanoid
    const randomCode = (0, nanoid_1.nanoid)(8);
 ...
 */
function generateQRCodeSVG(verificationCode) {
    try {
        // URL de verificación
 ...
 */
function renderDocumentHTML(formData, htmlTemplate) {
 ...
 */
function generateSignatureHTML(signatureData, verificationCode, qrCodeSvg) {
 ...
 */
async function generatePDF(documentHTML, signatureHTML) {
    try {
