...
mobileApiRouter.post('/store-login', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
mobileApiRouter.get('/document-types', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
mobileApiRouter.get('/transactions/:storeId', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
mobileApiRouter.post('/process-document', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
