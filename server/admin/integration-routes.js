...
integrationRouter.get('/crm/leads', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
integrationRouter.get('/crm/leads/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        // Obtener lead
        const [lead] = yield db_1.db
            .select()
            .from(schema_1.crmLeads)
...
integrationRouter.patch('/crm/leads/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        ...
        if (lead.crmExternalId) {
            yield crm_service_1.crmService.updateLead(lead);
        }
        res.json(lead);
    }
    catch (error) {
...
integrationRouter.get('/whatsapp/messages', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
integrationRouter.post('/whatsapp/send', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (templateName) {
            ...
            messageId = yield whatsapp_service_1.whatsappService.sendTemplateMessage(phoneNumber, templateName, parameters || {});
        }
        else {
            ...
            messageId = yield whatsapp_service_1.whatsappService.sendMessage(message);
...
integrationRouter.get('/dialogflow/sessions', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
integrationRouter.get('/dialogflow/sessions/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        // Obtener sesión
...
integrationRouter.patch('/dialogflow/sessions/:id/transfer', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
