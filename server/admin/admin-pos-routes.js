...
exports.adminPosRouter.post("/providers", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Insert provider
        const [provider] = yield db_1.db.insert(schema_1.posProviders).values(validationResult.data).returning();
...
exports.adminPosRouter.get("/providers", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const providers = yield db_1.db.select().from(schema_1.posProviders);
...
exports.adminPosRouter.put("/providers/:id", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        // Update provider
        const [updatedProvider] = yield db_1.db.update(schema_1.posProviders)
...
exports.adminPosRouter.post("/partners/:id/sync", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const partnerId = parseInt(req.params.id);
        // Sync transactions
        const result = yield pos_service_1.posService.syncPartnerSales(partnerId);
        if (!result.success) {
...
exports.adminPosRouter.get("/transactions", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const transactions = yield query.orderBy(schema_1.posTransactions.transactionDate);
...
exports.adminPosRouter.get("/summary", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const startDate = req.query.startDate ? new Date(req.query.startDate) : undefined;
        const endDate = req.query.endDate ? new Date(req.query.endDate) : undefined;
        // Get all partners
        const partnersList = yield db_1.db.select().from(schema_1.partners);
        // Get summary for each partner
        const summaries = yield Promise.all(partnersList.map((partner) => __awaiter(void 0, void 0, void 0, function* () {
            const summary = yield pos_service_1.posService.getPartnerSalesSummary(partner.id, startDate, endDate);
            return Object.assign({ partnerId: partner.id, partnerName: partner.storeName }, summary);
        })));
...
exports.adminPosRouter.post("/seed-providers", isAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Check if providers already exist
        const existingProviders = yield db_1.db.select().from(schema_1.posProviders);
        ...
        // Insert providers
        const insertedProviders = yield db_1.db.insert(schema_1.posProviders).values(providers).returning();
