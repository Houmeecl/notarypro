...
adminRouter.get('/dashboard', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d, _e;
    try {
        // Obtener estadísticas básicas
        const [leadsCount, messagesCount, dialogflowSessionsCount, templatesCount, rulesCount] = yield Promise.all([
        ...
        const leadsByStage = yield db_1.db
            .select({
        ...
        const recentMessages = yield db_1.db
            .select()
        ...
        res.json({
            stats: {
                leads: ((_a = leadsCount[0]) === null || _a === void 0 ? void 0 : _a.count) || 0,
                messages: ((_b = messagesCount[0]) === null || _b === void 0 ? void 0 : _b.count) || 0,
                dialogflowSessions: ((_c = dialogflowSessionsCount[0]) === null || _c === void 0 ? void 0 : _c.count) || 0,
                templates: ((_d = templatesCount[0]) === null || _d === void 0 ? void 0 : _d.count) || 0,
                rules: ((_e = rulesCount[0]) === null || _e === void 0 ? void 0 : _e.count) || 0
            },
            leadsByStage,
            recentMessages
        });
...
adminRouter.get('/users', admin_middleware_1.requireSuperAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
adminRouter.patch('/users/:id/role', admin_middleware_1.requireSuperAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { role } = req.body;
        // Validar el rol
...
adminRouter.get('/message-templates', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const templates = yield db_1.db
            .select()
...
adminRouter.post('/message-templates', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
adminRouter.patch('/message-templates/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
...
adminRouter.get('/automation-rules', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const rules = yield db_1.db
            .select()
...
adminRouter.post('/automation-rules', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
adminRouter.patch('/automation-rules/:id', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        const { name, description, triggerType, triggerEvent, triggerSchedule, triggerCondition, actionType, actionConfig, isActive } = req.body;
        // Actualizar regla
...
adminRouter.post('/initialize-admin', admin_middleware_1.requireSuperAdmin, (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield (0, seed_admin_1.createSuperAdmin)();
...
adminRouter.get('/master-dashboard', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    var _a, _b, _c, _d;
    try {
        // Obtener estadísticas de documentos
        const [totalDocumentsResult, documentsLastMonthResult] = yield Promise.all([
        ...
        const totalDocuments = Number(((_a = totalDocumentsResult[0]) === null || _a === void 0 ? void 0 : _a.count) || 0);
        const documentsLastMonth = Number(((_b = documentsLastMonthResult[0]) === null || _b === void 0 ? void 0 : _b.count) || 0);
        ...
        const [totalUsersResult, newUsersLastMonthResult] = yield Promise.all([
        ...
        const totalUsers = Number(((_c = totalUsersResult[0]) === null || _c === void 0 ? void 0 : _c.count) || 0);
        const newUsersLastMonth = Number(((_d = newUsersLastMonthResult[0]) === null || _d === void 0 ? void 0 : _d.count) || 0);
        ...
        const documentsByStatusQuery = yield db_1.db
            .select({
        ...
        const pendingDocuments = yield db_1.db
            .select({
...
adminRouter.get('/system-status', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
adminRouter.get('/documents', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const usersList = userIds.length > 0
            ? yield db_1.db.select().from(schema_1.users).where(userIds.length === 1
        ...
        const certifiersList = certifierIds.length > 0
            ? yield db_1.db.select().from(schema_1.users).where(certifierIds.length === 1
        ...
        const documentsWithDetails = docs.map(doc => {
            ...
            return Object.assign(Object.assign({}, doc), { userName: (user === null || user === void 0 ? void 0 : user.fullName) || 'Usuario Desconocido', userEmail: (user === null || user === void 0 ? void 0 : user.email) || 'email@desconocido.com', certifierName: certifier === null || certifier === void 0 ? void 0 : certifier.fullName, verificationCode: `VC-${doc.id}-${Math.floor(Math.random() * 900000) + 100000}`, documentType: doc.documentType || 'general', fileSize: Math.floor(Math.random() * 5000000) + 500000 // Tamaño simulado entre 500KB y 5MB
             });
        });
...
adminRouter.get('/certifiers', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const certifiersList = yield query;
...
adminRouter.get('/ai-analysis', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Importar el servicio de OpenAI
        const { openaiService } = yield Promise.resolve().then(() => __importStar(require('../services/openai-service')));
        ...
        const operationalData = yield getOperationalData(type);
        ...
        try {
            ...
            analysisData = yield openaiService.generateStrategicAnalysis(type, operationalData, { model: "gpt-4o" });
            ...
            const marketingEmails = yield generateMarketingEmails();
...
adminRouter.post('/ai-analysis/generate', (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // Importar el servicio de OpenAI
        const { openaiService } = yield Promise.resolve().then(() => __importStar(require('../services/openai-service')));
        const { analysisType, model, depth, includeRecommendations } = req.body;
        // Obtener datos para el análisis
        const operationalData = yield getOperationalData(analysisType);
        // Generar análisis usando OpenAI
        const analysisData = yield openaiService.generateStrategicAnalysis(analysisType, operationalData, {
            model,
            depth,
...
function getOperationalData(analysisType) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        switch (analysisType) {
            case 'business':
                return Object.assign(Object.assign({}, baseData), { costStructure: {
                        operations: 9500000,
                        marketing: 3200000,
                        technology: 4800000,
            ...
            case 'market':
                return Object.assign(Object.assign({}, baseData), { marketSizeEstimate: 8500000000, marketGrowthRate: 15, competitorsInfo: [
            ...
            case 'expansion':
                return Object.assign(Object.assign({}, baseData), { regions: [
            ...
            case 'pricing':
                return Object.assign(Object.assign({}, baseData), { currentPrices: [
            ...
            case 'marketing':
                return Object.assign(Object.assign({}, baseData), { marketingBudget: 3200000, currentChannels: [
...
function generateMarketingEmails() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Importar el servicio de OpenAI
            const { openaiService } = yield Promise.resolve().then(() => __importStar(require('../services/openai-service')));
            // Generar emails de marketing
            const abandonmentEmail = yield openaiService.generateMarketingEmail("Recuperar clientes que abandonaron el proceso de certificación", "Usuarios que iniciaron pero no completaron el proceso de certificación", {
            ...
            const promotionEmail = yield openaiService.generateMarketingEmail("Promover paquete empresarial de certificaciones", "Empresas con necesidades frecuentes de certificación documental", {
