...
class S3StorageProvider {
    ...
    storeDocument(documentId_1, documentData_1, metadata_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, documentData, metadata, encryptionType = EncryptionType.AES_256_GCM) {
            try {
                ...
                const metadataWithEncryption = Object.assign(Object.assign(Object.assign({}, metadata), { documentId,
                    documentHash,
                    encryptionType, iv: iv.toString('base64') }), (authTag ? { authTag: authTag.toString('base64') } : {}));
                ...
                const uploadParams = {
                    ...
                    Metadata: Object.assign(Object.assign({ 'x-amz-meta-encrypted': 'true', 'x-amz-meta-encryption-type': encryptionType, 'x-amz-meta-document-hash': documentHash, 'x-amz-meta-metadata-iv': metadataIv.toString('base64') }, (metadataAuthTag ? { 'x-amz-meta-metadata-auth-tag': metadataAuthTag.toString('base64') } : {})), { 'x-amz-meta-encrypted-metadata': encryptedMetadata.toString('base64') })
                };
                ...
                const presignedUrl = yield (0, s3_request_presigner_1.getSignedUrl)(this.s3Client, cmd, { expiresIn });
                // Guardar registro en la base de datos
                yield db_1.db.insert(documentStorageRecords).values({
                    id: storageId,
                    documentId,
                    provider: this.name,
                    encryptionType,
                    ...
                    documentHash,
                    createdAt: new Date(),
                    metadata: Object.assign({ encryptedMetadataBase64: encryptedMetadata.toString('base64'), metadataIv: metadataIv.toString('base64') }, (metadataAuthTag ? { metadataAuthTag: metadataAuthTag.toString('base64') } : {}))
                });
                return {
                    success: true,
                    storageId,
    ...
    retrieveDocument(storageId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información del documento
                const [storageRecord] = yield db_1.db
                    .select()
                ...
                const response = yield this.s3Client.send(new client_s3_1.GetObjectCommand(getParams));
                if (!response.Body) {
                    throw new Error('No se pudo obtener el cuerpo del documento');
                }
                // Convertir stream a buffer
                const encryptedData = yield streamToBuffer(response.Body);
                // Extraer metadatos
                ...
                if ((options === null || options === void 0 ? void 0 : options.decrypt) === false) {
                    return {
                        data: encryptedData,
                        metadata
                    };
    ...
    generatePresignedUrl(storageId_1) {
        return __awaiter(this, arguments, void 0, function* (storageId, expiresIn = 3600) {
            try {
                // Obtener información del documento
                const [storageRecord] = yield db_1.db
                    .select()
                ...
                return yield (0, s3_request_presigner_1.getSignedUrl)(this.s3Client, cmd, { expiresIn });
            }
            catch (error) {
    ...
    storeDocument(documentId_1, documentData_1, metadata_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, documentData, metadata, encryptionType = EncryptionType.AES_256_GCM) {
            try {
                ...
                const metadataToStore = Object.assign({ encryptedMetadataBase64: encryptedMetadata.toString('base64'), metadataIv: metadataIv.toString('base64') }, (metadataAuthTag ? { metadataAuthTag: metadataAuthTag.toString('base64') } : {}));
                ...
                yield db_1.db.insert(documentStorageRecords).values({
                    ...
                    documentHash,
                    createdAt: new Date(),
                    metadata: Object.assign({ encryptedMetadataBase64: encryptedMetadata.toString('base64'), metadataIv: metadataIv.toString('base64'), metadataPath: metadataPath }, (metadataAuthTag ? { metadataAuthTag: metadataAuthTag.toString('base64') } : {}))
                });
                return {
                    success: true,
                    storageId,
...
class SecureStorageService {
     ...
     */
    storeDocument(documentId, documentData, metadata, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const encryptionType = (options === null || options === void 0 ? void 0 : options.encryptionType) || EncryptionType.AES_256_GCM;
                return yield provider.storeDocument(documentId, documentData, metadata, encryptionType);
            }
            catch (error) {
                ...
                return {
                    success: false,
                    storageId: (0, uuid_1.v4)(),
                    provider: (options === null || options === void 0 ? void 0 : options.provider) || StorageProvider.LOCAL,
                    encryptionType: (options === null || options === void 0 ? void 0 : options.encryptionType) || EncryptionType.AES_256_GCM,
                    documentHash: '',
                    error: error.message || 'Error desconocido al almacenar documento'
                };
            }
    ...
    retrieveDocument(storageId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield provider.retrieveDocument(storageId, options);
            }
            catch (error) {
    ...
    generatePresignedUrl(storageId_1) {
        return __awaiter(this, arguments, void 0, function* (storageId, expiresIn = 3600) {
            try {
                ...
                const provider = SecureStorageProviderFactory.getProvider(storageRecord.provider);
                return yield provider.generatePresignedUrl(storageId, expiresIn);
            }
            catch (error) {
    ...
    deleteDocument(storageId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const provider = SecureStorageProviderFactory.getProvider(storageRecord.provider);
                return yield provider.deleteDocument(storageId);
            }
            catch (error) {
     ...
     */
    verifyDocumentIntegrity(storageId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información del almacenamiento
                const [storageRecord] = yield db_1.db
                ...
                const { data, metadata } = yield provider.retrieveDocument(storageId);
                // Verificar hash
                const hash = crypto_1.default.createHash('sha256');
                hash.update(data);
                const calculatedHash = hash.digest('hex');
