...
class GetAPIService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                if (axios_1.default.isAxiosError(error) && error.response) {
                    return {
                        success: false,
                        error: ((_a = error.response.data) === null || _a === void 0 ? void 0 : _a.error) || error.message,
     ...
     */
    validateIdentityDocument(frontImage, backImage, faceImage) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    verifyFacialIdentity(faceImage, documentId, sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // Preparar datos para enviar
            const payload = {
     ...
     * @param sessionId Identificador de sesión para trazabilidad (opcional)
     */
    verifyLiveness(faceImage, sessionId) {
        return __awaiter(this, void 0, void 0, function* () {
            // Preparar datos para enviar
            const payload = {
                faceImage: faceImage.startsWith('data:') ? faceImage : `data:image/jpeg;base64,${faceImage}`,
     ...
     */
    quickVerifyIdentity(rut, fullName, birthDate) {
        return __awaiter(this, void 0, void 0, function* () {
