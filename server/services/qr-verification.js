...
class QRVerificationService {
     ...
     */
    generateDocumentVerificationQR(documentId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const expiresInDays = (options === null || options === void 0 ? void 0 : options.expiresInDays) || 365; // 1 año por defecto
                ...
                yield db_1.db.insert(documentQrCodes).values({
                    id: qrCodeId,
                    documentId,
                    ...
                    expiresAt,
                    details: {
                        includeSignatures: (options === null || options === void 0 ? void 0 : options.includeSignatures) || false,
                ...
                const qrImageBase64 = yield this.generateQRImageBase64(verificationUrl, size);
                return {
                    success: true,
                    qrCodeId,
                    qrImageBase64,
     ...
     */
    generateSignatureVerificationQR(signatureId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [docSignature] = yield db_1.db
                    .select()
     ...
     */
    generateMobileSigningQR(documentId, userId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Verificar que el documento existe
                const [document] = yield db_1.db
                ...
                const expiresInHours = (options === null || options === void 0 ? void 0 : options.expiresInHours) || 24; // 24 horas por defecto
                const expiresAt = new Date();
                ...
                yield db_1.db.insert(documentQrCodes).values({
                    ...
                    createdAt: new Date(),
                    expiresAt,
                    details: Object.assign(Object.assign({}, options === null || options === void 0 ? void 0 : options.additionalData), { createdAt: new Date().toISOString() })
                });
                ...
                // Generar imagen QR
                const size = (options === null || options === void 0 ? void 0 : options.size) || 200;
                const qrImageBase64 = yield this.generateQRImageBase64(signingUrl, size);
                return {
                    success: true,
                    qrCodeId,
                    qrImageBase64,
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const result = {
                    ...
                    details: Object.assign({ documentTitle: document.title, documentType: document.type, createdAt: document.createdAt }, qrCode.details)
                };
                ...
                if (qrCode.signatureId) {
                    ...
                    if (signature) {
                        result.details = Object.assign(Object.assign({}, result.details), { signatureProvider: signature.provider, signatureType: signature.type, signatureStatus: signature.status, signatureCreatedAt: signature.createdAt });
                    }
                }
                return result;
            }
     ...
     */
    generateQRImageBase64(data_1) {
        return __awaiter(this, arguments, void 0, function* (data, size = 200) {
            try {
                const qrOptions = {
                ...
                return yield qrcode_1.default.toDataURL(data, qrOptions);
            }
            catch (error) {
