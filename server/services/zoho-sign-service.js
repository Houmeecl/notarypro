...
function getAccessToken() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        try {
            ...
            const response = yield axios_1.default.post(`${ZOHO_ACCOUNTS_URL}/oauth/v2/token`, null, {
                params: {
 ...
 */
function createSigningRequest(signRequest) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const documentData = yield fs_1.promises.readFile(signRequest.document_path);
            ...
            const response = yield axios_1.default.post(`${ZOHO_SIGN_API_URL}/requests`, formData, {
                headers: Object.assign(Object.assign({}, formData.getHeaders()), { 'Authorization': `Zoho-oauthtoken ${token}` })
            });
 ...
 */
function getSigningRequestStatus(requestId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = yield getAccessToken();
            const response = yield axios_1.default.get(`${ZOHO_SIGN_API_URL}/requests/${requestId}`, {
                headers: {
 ...
 */
function downloadSignedDocument(requestId, documentId, outputPath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = yield getAccessToken();
            const response = yield axios_1.default.get(`${ZOHO_SIGN_API_URL}/requests/${requestId}/documents/${documentId}/pdf`, {
                headers: {
                    'Authorization': `Zoho-oauthtoken ${token}`
                },
                responseType: 'arraybuffer'
            });
            yield fs_1.promises.writeFile(outputPath, response.data);
            return outputPath;
        }
        catch (error) {
...
function sendReminder(requestId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = yield getAccessToken();
            const response = yield axios_1.default.post(`${ZOHO_SIGN_API_URL}/requests/${requestId}/reminder`, {}, {
                headers: {
                    'Authorization': `Zoho-oauthtoken ${token}`,
 ...
 * @returns Respuesta de la API
 */
function cancelSigningRequest(requestId) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const token = yield getAccessToken();
            const response = yield axios_1.default.delete(`${ZOHO_SIGN_API_URL}/requests/${requestId}`, {
                headers: {
                    'Authorization': `Zoho-oauthtoken ${token}`
                }
            });
 ...
 */
function verifyZohoAuthentication() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
