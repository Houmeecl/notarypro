...
class DocuSignProvider {
    ...
    getAccessToken() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield axios_1.default.post(`${this.authServer}/oauth/token`, 'grant_type=client_credentials&scope=signature', {
                    headers: {
    ...
    initSignature(documentId, userId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [document] = yield db_1.db.select().from(schema_1.documents).where((0, drizzle_orm_1.eq)(schema_1.documents.id, documentId));
                if (!user || !document) {
                ...
                const envelopeResponse = yield axios_1.default.post(`${this.baseUrl}/v2.1/accounts/${this.accountId}/envelopes`, envelopeDefinition, {
                    headers: {
                ...
                const viewResponse = yield axios_1.default.post(`${this.baseUrl}/v2.1/accounts/${this.accountId}/envelopes/${envelopeId}/views/recipient`, recipientViewRequest, {
                    headers: {
                        'Authorization': `Bearer ${accessToken}`,
                        'Content-Type': 'application/json'
                    }
                ...
                const verificationCode = yield this.generateVerificationCode(signatureId);
                // Guardar registro de firma en base de datos
                yield db_1.db.insert(signatures).values({
                    id: signatureId,
                    userId,
                    provider: this.name,
                ...
                yield db_1.db.insert(documentSignatures).values({
                    documentId,
                    signatureId,
                    userId,
                    createdAt: new Date()
    ...
    checkSignatureStatus(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información de la firma
                const [signature] = yield db_1.db
                    .select()
                    .from(signatures)
                ...
                const envelopeResponse = yield axios_1.default.get(`${this.baseUrl}/v2.1/accounts/${this.accountId}/envelopes/${envelopeId}`, {
                    headers: {
                        'Authorization': `Bearer ${accessToken}`
                    }
                });
                ...
                yield db_1.db
                    ...
                    status,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, signature.details), { docusignStatus: envelopeResponse.data.status, lastChecked: new Date().toISOString() })
                })
                    .where((0, drizzle_orm_1.eq)(signatures.id, signatureId));
                return status;
            }
    ...
    getSignatureDetails(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener información de la firma
                const [signature] = yield db_1.db
    ...
    generateVerificationCode(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
    ...
    initSignature(documentId, userId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                // Crear solicitud de firma en HelloSign
                const response = yield axios_1.default.post(`${this.baseUrl}/signature_request/create_embedded`, signatureRequestData, {
                    headers: {
                ...
                const signatureResponse = yield axios_1.default.get(`${this.baseUrl}/embedded/sign_url/${response.data.signatures[0].signature_id}`, {
                    headers: {
                        'Authorization': `Basic ${auth}`
                    }
                });
    ...
    checkSignatureStatus(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const response = yield axios_1.default.get(`${this.baseUrl}/signature_request/${signatureRequestId}`, {
                    headers: {
                        'Authorization': `Basic ${auth}`
                    }
                });
                ...
                yield db_1.db
                    ...
                    status,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, signature.details), { helloSignStatus: status, lastChecked: new Date().toISOString() })
                })
                    .where((0, drizzle_orm_1.eq)(signatures.id, signatureId));
                return status;
            }
...
class ETokenProvider {
    ...
    completeETokenSignature(signatureId, signatureData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [signature] = yield db_1.db
                    .select()
                ...
                yield db_1.db
                    ...
                    status: SignatureStatus.COMPLETED,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, signature.details), { completedAt: new Date().toISOString(), certificate: signatureData.certificate, timestamp: signatureData.timestamp, signature: signatureData.signature })
                })
                    .where((0, drizzle_orm_1.eq)(signatures.id, signatureId));
...
class SimpleSignatureProvider {
    ...
    completeSimpleSignature(signatureId, signatureImageData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [signature] = yield db_1.db
                    .select()
                ...
                yield db_1.db
                    ...
                    status: SignatureStatus.COMPLETED,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, signature.details), { completedAt: new Date().toISOString(), signatureImage: signatureImageData })
                })
                    .where((0, drizzle_orm_1.eq)(signatures.id, signatureId));
                return SignatureStatus.COMPLETED;
            }
...
class ElectronicSignatureService {
     ...
     */
    initSignature(documentId_1, userId_1) {
        return __awaiter(this, arguments, void 0, function* (documentId, userId, type = SignatureType.ADVANCED, provider) {
            try {
                ...
                return yield signatureProvider.initSignature(documentId, userId, type);
            }
            catch (error) {
    ...
    checkSignatureStatus(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield provider.checkSignatureStatus(signatureId);
            }
            catch (error) {
    ...
    getSignatureDetails(signatureId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const provider = ElectronicSignatureProviderFactory.getProvider(signature.provider);
                return yield provider.getSignatureDetails(signatureId);
            }
            catch (error) {
    ...
    completeETokenSignature(signatureId, signatureData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield provider.completeETokenSignature(signatureId, signatureData);
            }
            catch (error) {
                console.error('Error al completar firma con eToken:', error);
                return SignatureStatus.ERROR;
    ...
    completeSimpleSignature(signatureId, signatureImageData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield provider.completeSimpleSignature(signatureId, signatureImageData);
            }
            catch (error) {
                console.error('Error al completar firma simple:', error);
                return SignatureStatus.ERROR;
     ...
     */
    verifySignature(verificationCode) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [documentSignature] = yield db_1.db
                    .select()
     ...
     */
    generateVerificationQR(signatureId, options) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [signature] = yield db_1.db
                    .select()
                ...
                // Datos para el QR
                const qrData = (options === null || options === void 0 ? void 0 : options.includeVerificationUrl)
                    ? verificationUrl
                    : verificationCode;
