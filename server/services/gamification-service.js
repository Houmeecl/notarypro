 ...
 */
function updateUserVerificationStats(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const profile = yield getUserGameProfile(userId);
 ...
 */
function addPointsToUser(userId, points, activityType, description) {
    return __awaiter(this, void 0, void 0, function* () {
        let profile = yield getUserGameProfile(userId);
 ...
 */
function verifyDocument(userId, code) {
    return __awaiter(this, void 0, void 0, function* () {
        // Comprobar si el documento existe y no ha sido verificado
        const [doc] = yield db_1.db
            .select({
  ...
  `);
        ...
        yield updateUserVerificationStats(userId);
        // Añadir puntos por la verificación (15 puntos base)
        const pointsEarned = 15;
        yield addPointsToUser(userId, pointsEarned, 'verificación', `Verificación del documento: ${doc.title}`);
        // Actualizar progreso en desafíos relacionados
        yield updateChallengesProgress(userId, 'verification', { documentId: doc.id });
        // Verificar logros que podrían haberse desbloqueado
        yield checkForNewBadges(userId);
        // Actualizar tabla de clasificación
        yield updateLeaderboard(userId);
        return {
            id: verification.id,
            code,
            documentId: doc.id,
 ...
 */
function updateChallengesProgress(userId_1, actionType_1) {
    return __awaiter(this, arguments, void 0, function* (userId, actionType, metadata = {}) {
        ...
        const activeChallenges = yield db_1.db
            .select()
        ...
        for (const challenge of activeChallenges) {
            ...
            if (isCompleted) {
                ...
                yield addPointsToUser(userId, challenge.points, 'desafío_completado', `Desafío completado: ${challenge.title}`);
            }
            else {
                // Actualizar progreso
                yield db_1.db
    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const badge of availableBadges) {
            ...
            if (profile.totalPoints >= badge.requiredPoints) {
                ...
                // Registrar la actividad
                yield addPointsToUser(userId, 50, // Bonus por ganar insignia
...
function updateLeaderboard(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield updatePeriodLeaderboard(userId, 'diario', startOfDay, endOfDay);
        // Actualizar o crear entrada para período semanal
        yield updatePeriodLeaderboard(userId, 'semanal', startOfWeek, endOfWeek);
        // Actualizar o crear entrada para período mensual
        yield updatePeriodLeaderboard(userId, 'mensual', startOfMonth, endOfMonth);
        // Actualizar o crear entrada para puntuación total
        yield updateTotalLeaderboard(userId);
    });
}
/**
 * Actualiza la entrada de tabla de clasificación para un período específico
 */
function updatePeriodLeaderboard(userId, period, startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        // Calcular puntuación para el período
        const periodActivities = yield db_1.db
            .select({
        ...
        const score = ((_a = periodActivities[0]) === null || _a === void 0 ? void 0 : _a.totalPoints) || 0;
        // Buscar entrada existente
        const [existingEntry] = yield db_1.db
            .select()
        ...
        yield recalculatePeriodRankings(period, startDate, endDate);
    });
}
/**
 * Actualiza la entrada de tabla de clasificación para puntuación total
 */
function updateTotalLeaderboard(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        // Obtener perfil del usuario
        const profile = yield getUserGameProfile(userId);
        // Buscar entrada existente
        ...
        yield recalculatePeriodRankings('total', startDate, endDate);
    });
}
/**
 * Recalcula los rankings para un período específico
 */
function recalculatePeriodRankings(period, startDate, endDate) {
    return __awaiter(this, void 0, void 0, function* () {
...
function getLeaderboard() {
    return __awaiter(this, arguments, void 0, function* (period = 'mensual', limit = 10) {
        ...
        const leaderboard = yield db_1.db
            .select({
...
function getUserChallenges(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield getUserGameProfile(userId);
        ...
        const userProgress = yield db_1.db
            .select()
            .from(schema_1.userChallengeProgress)
        ...
        for (const challenge of activeChallenges) {
            ...
            if (!progress) {
                ...
                const [createdProgress] = yield db_1.db
                    .insert(schema_1.userChallengeProgress)
                    .values({
                    userId,
                    challengeId: challenge.id,
                ...
                challengesWithProgress.push(Object.assign(Object.assign({}, progress), { challenge }));
            }
        }
...
function getUserRewards(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const userRewards = yield db_1.db
            .select({
...
function claimReward(userId, rewardId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const [existingClaim] = yield db_1.db
            .select()
            .from(schema_1.userClaimedRewards)
        ...
        const [claimedReward] = yield db_1.db
            ...
            .returning();
        // Registrar la actividad
        yield addPointsToUser(userId, 0, // No da puntos reclamar recompensas
 ...
 */
function getUserLeaderboardPosition(userId_1) {
    return __awaiter(this, arguments, void 0, function* (userId, period = 'mensual') {
        var _a;
        // Obtener fecha actual y calcular período
        const now = new Date();
        let startDate, endDate;
        ...
        const totalCount = yield db_1.db
            .select({ count: (0, drizzle_orm_1.sql) `count(*)` })
            .from(schema_1.leaderboardEntries)
            .where((0, drizzle_orm_1.and)((0, drizzle_orm_1.eq)(schema_1.leaderboardEntries.period, period), (0, drizzle_orm_1.between)(schema_1.leaderboardEntries.periodStart, startDate, endDate)));
        const totalPlayers = ((_a = totalCount[0]) === null || _a === void 0 ? void 0 : _a.count) || 0;
        const percentile = totalPlayers > 0 ? Math.round((1 - (userEntry.rank / totalPlayers)) * 100) : 0;
        return Object.assign(Object.assign({}, userEntry), { totalPlayers,
            percentile });
    });
}
/**
 ...
 */
function getVerificationStats(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        totalVerifications = Number((totalResult === null || totalResult === void 0 ? void 0 : totalResult.count) || 0);
        ...
        const byDayResults = yield byDayQuery;
  ...
  `);
        ...
        const mostVerifiedResults = yield mostVerifiedQuery;
...
function getUserActivities(userId_1) {
    return __awaiter(this, arguments, void 0, function* (userId, limit = 20) {
        const activities = yield db_1.db
            .select()
            .from(schema_1.gamificationActivities)
 ...
 */
function processDocumentVerification(userId, code) {
    return __awaiter(this, void 0, void 0, function* () {
        return yield verifyDocument(userId, code);
    });
}
/**
 * Obtiene las recompensas disponibles para un usuario
 */
function getAvailableRewardsForUser(userId) {
    return __awaiter(this, void 0, void 0, function* () {
        const profile = yield getUserGameProfile(userId);
        ...
        const rewardsWithAvailability = rewards.map(reward => (Object.assign(Object.assign({}, reward), { canClaim: profile.totalPoints >= reward.requiredPoints, pointsNeeded: Math.max(0, reward.requiredPoints - profile.totalPoints) })));
...
function seedDefaultChallenges() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const existingChallenges = yield db_1.db
            .select({ count: (0, drizzle_orm_1.sql) `count(*)` })
            .from(schema_1.verificationChallenges);
        if (((_a = existingChallenges[0]) === null || _a === void 0 ? void 0 : _a.count) > 0) {
        ...
        yield db_1.db.insert(schema_1.verificationChallenges).values(defaultChallenges);
...
function seedDefaultBadges() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const existingBadges = yield db_1.db
            .select({ count: (0, drizzle_orm_1.sql) `count(*)` })
            .from(schema_1.verificationBadges);
        if (((_a = existingBadges[0]) === null || _a === void 0 ? void 0 : _a.count) > 0) {
        ...
        yield db_1.db.insert(schema_1.verificationBadges).values(defaultBadges);
 ...
 */
function seedDefaultRewards() {
    return __awaiter(this, void 0, void 0, function* () {
        var _a;
        // Comprobar si ya hay recompensas
        const existingRewards = yield db_1.db
            .select({ count: (0, drizzle_orm_1.sql) `count(*)` })
            .from(schema_1.gamificationRewards);
        if (((_a = existingRewards[0]) === null || _a === void 0 ? void 0 : _a.count) > 0) {
        ...
        yield db_1.db.insert(schema_1.gamificationRewards).values(defaultRewards);
...
function resetTable(tableName) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield db_1.db.execute((0, drizzle_orm_1.sql) `TRUNCATE TABLE ${drizzle_orm_1.sql.identifier(tableName)} CASCADE`);
