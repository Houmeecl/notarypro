...
class S3StorageService {
    ...
    uploadFile(key_1, data_1) {
        return __awaiter(this, arguments, void 0, function* (key, data, options = {}) {
            ...
            try {
                ...
                const s3Metadata = Object.assign(Object.assign({}, options.metadata), { 'content-hash': contentHash, 'encrypted': String(isEncrypted), 'created-at': now.toISOString() });
                if (expiresAt) {
        ...
        return __awaiter(this, arguments, void 0, function* (key, options = {}) {
            ...
            try {
                ...
                const metadata = {
                    ...
                    createdAt,
                    expiresAt,
                    customMetadata: Object.assign({}, s3Metadata)
                };
    ...
    generatePresignedUrl(key_1) {
        return __awaiter(this, arguments, void 0, function* (key, expiresInSeconds = 60 * 60 // 1 hora por defecto
        ) {
            if (!this.isConfigured()) {
                console.error('S3 storage not properly configured');
                return null;
