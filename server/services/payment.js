 ...
 */
function createPaymentPreference(items, payer, backUrls, externalReference) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const result = yield preference.create({ body: preferenceData });
            return result;
        }
        catch (error) {
...
function processPayment(paymentData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const formattedPaymentData = Object.assign(Object.assign({}, paymentData), { issuer_id: parseInt(paymentData.issuer_id, 10) || 0 // Convertir a número o usar 0 como valor por defecto
             });
            const result = yield payment.create({ body: formattedPaymentData });
            return result;
        }
        catch (error) {
