...
class MicroInteractionsService {
     ...
     */
    createMicroInteraction(interaction) {
        return __awaiter(this, void 0, void 0, function* () {
            const [newInteraction] = yield db_1.db
     ...
     */
    getAllMicroInteractions() {
        return __awaiter(this, void 0, void 0, function* () {
            return yield db_1.db.select().from(schema_1.microInteractions);
        });
    }
    /**
     * Obtiene micro-interacciones para un tipo de evento específico
     */
    getMicroInteractionsByEvent(triggerEvent) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    triggerInteractions(userId_1, eventType_1) {
        return __awaiter(this, arguments, void 0, function* (userId, eventType, context = {}) {
            // 1. Obtener todas las micro-interacciones aplicables a este evento
            const availableInteractions = yield this.getMicroInteractionsByEvent(eventType);
            if (!availableInteractions.length) {
                return [];
            }
            // 2. Filtrar interacciones según nivel de usuario y frecuencia
            const userProfile = yield this.getUserGameProfile(userId);
            const userLevel = (userProfile === null || userProfile === void 0 ? void 0 : userProfile.level) || 1;
            // 3. Obtener historial reciente para verificar cooldowns
            const recentHistory = yield db_1.db
                .select()
            ...
            for (const interaction of eligibleInteractions) {
                yield this.recordInteractionHistory(userId, interaction.id, interaction.pointsAwarded, context);
                // Si otorga puntos, actualizar el perfil del usuario
                if (interaction.pointsAwarded > 0) {
                    yield this.awardPoints(userId, interaction.pointsAwarded, `Micro-interacción: ${interaction.name}`);
                }
            }
     ...
     */
    recordInteractionHistory(userId_1, interactionId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, interactionId, pointsAwarded = 0, context = {}) {
            const [record] = yield db_1.db
     ...
     */
    createQuickAchievement(achievement) {
        return __awaiter(this, void 0, void 0, function* () {
            const [newAchievement] = yield db_1.db
    ...
    checkAndUpdateAchievements(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const allAchievements = yield db_1.db
                .select()
            ...
            for (const achievement of allAchievements) {
                ...
                if (newValue >= achievement.threshold) {
                    ...
                    if (achievement.rewardPoints > 0) {
                        yield this.awardPoints(userId, achievement.rewardPoints, `Logro desbloqueado: ${achievement.name}`);
                    }
                }
            ...
            for (const progress of achievementsToUpdate) {
                if (progressMap.has(progress.achievementId)) {
                    ...
                    yield db_1.db
                        ...
                        .values(Object.assign(Object.assign({}, progress), { lastUpdated: new Date() }));
                }
            }
    ...
    getUserAchievements(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            const achievements = yield db_1.db
                .select({
     ...
     */
    getPublicAchievementInfo(achievementId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                // Obtener el logro y el usuario que lo ha desbloqueado
                const [achievementInfo] = yield db_1.db
                    .select({
                    id: schema_1.quickAchievements.id,
                    name: schema_1.quickAchievements.name,
                    description: schema_1.quickAchievements.description,
        ...
        `);
                ...
                const publicInfo = {
                    ...
                    userName: (userInfo === null || userInfo === void 0 ? void 0 : userInfo.username) || 'Usuario Cerfidoc',
