...
class CrmService {
    ...
    updateLead(lead) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                yield axios_1.default.patch(`${this.apiUrl}/leads/${lead.crmExternalId}`, crmData, {
                    headers: {
                        'Authorization': `Bearer ${this.apiKey}`,
                        'Content-Type': 'application/json'
                    }
    ...
    getLead(externalId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield axios_1.default.get(`${this.apiUrl}/leads/${externalId}`, {
                    headers: {
                        'Authorization': `Bearer ${this.apiKey}`
                    }
                });
    ...
    searchLeads(query) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                const response = yield axios_1.default.get(`${this.apiUrl}/leads/search?${params.toString()}`, {
                    headers: {
                        'Authorization': `Bearer ${this.apiKey}`
                    }
                });
     ...
     */
    trackActivity(externalId, activityType, activityData) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!this.apiKey || !this.apiUrl) {
                console.warn('CRM API configuration is incomplete');
                return false;
            ...
            try {
                ...
                yield axios_1.default.post(`${this.apiUrl}/leads/${externalId}/activities`, {
                    type: activityType,
