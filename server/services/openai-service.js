...
class OpenAIService {
     ...
     */
    generateStrategicAnalysis(analysisType_1, data_1) {
        return __awaiter(this, arguments, void 0, function* (analysisType, data, options = {}) {
     ...
     */
    generateMarketingEmail(objective_1, audience_1, productInfo_1) {
        return __awaiter(this, arguments, void 0, function* (objective, audience, productInfo, options = {}) {
            // Configurar opciones por defecto
            const model = options.model || "gpt-4o";
