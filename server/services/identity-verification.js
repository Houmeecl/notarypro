    ...
    initVerification(userId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const applicantResponse = yield axios_1.default.post(`${this.apiUrl}/applicants`, {
                ...
                const sdkTokenResponse = yield axios_1.default.post(`${this.apiUrl}/sdk_token`, {
                ...
                yield db_1.db.insert(schema_1.identityVerifications).values({
                    id: verificationId,
                    userId,
                    provider: this.name,
    ...
    checkVerificationStatus(verificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [verification] = yield db_1.db
                    .select()
                ...
                const checksResponse = yield axios_1.default.get(`${this.apiUrl}/applicants/${applicantId}/checks`, {
                    headers: {
                        'Authorization': `Token token=${this.apiKey}`
                    }
                });
                ...
                yield db_1.db
                    ...
                    status,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, verification.details), { checkStatus: latestCheck.status, checkResult: latestCheck.result, lastChecked: new Date().toISOString() })
                })
                    .where((0, drizzle_orm_1.eq)(schema_1.identityVerifications.id, verificationId));
                return status;
            }
    ...
    initVerification(userId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transactionResponse = yield axios_1.default.post(`${this.apiUrl}/web/v4/initiateNetverify`, {
    ...
    checkVerificationStatus(verificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const transactionResponse = yield axios_1.default.get(`${this.apiUrl}/web/v4/transactions/${transactionReference}`, {
                    headers: {
                        'Authorization': `Basic ${auth}`,
                        'User-Agent': 'NotaryPro/1.0.0'
                    }
                ...
                yield db_1.db
                    ...
                    status,
                    updatedAt: new Date(),
                    details: Object.assign(Object.assign({}, verification.details), { jumioStatus: transactionResponse.data.status, lastChecked: new Date().toISOString() })
                })
                    .where((0, drizzle_orm_1.eq)(schema_1.identityVerifications.id, verificationId));
                return status;
            }
    ...
    initVerification(userId, type) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const verificationResponse = yield axios_1.default.post(`${this.apiUrl}${endpoint}`, payload, {
                    headers: {
...
class InternalProvider {
    ...
    completeVerificationStep(verificationId, step, stepData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [verification] = yield db_1.db
                    .select()
                ...
                const stepDetails = Object.assign(Object.assign({}, verification.details), { completedSteps, [`${step}Data`]: stepData, [`${step}CompletedAt`]: new Date().toISOString() });
...
class IdentityVerificationService {
    initVerification(userId_1) {
        return __awaiter(this, arguments, void 0, function* (userId, type = VerificationType.COMBINED, provider) {
            try {
                ...
                return yield verificationProvider.initVerification(userId, type);
            }
            catch (error) {
    ...
    checkVerificationStatus(verificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return yield provider.checkVerificationStatus(verificationId);
            }
            catch (error) {
    ...
    getVerificationDetails(verificationId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const provider = IdentityVerificationProviderFactory.getProvider(verification.provider);
                return yield provider.getVerificationDetails(verificationId);
            }
            catch (error) {
                console.error('Error al obtener detalles de verificación:', error);
                return { error: error.message };
    ...
    completeInternalVerificationStep(verificationId, step, stepData) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const [verification] = yield db_1.db
                    .select()
                ...
                return yield internalProvider.completeVerificationStep(verificationId, step, stepData);
            }
            catch (error) {
    ...
    getUserVerifications(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userVerifications = yield db_1.db
                    .select()
                    .from(schema_1.identityVerifications)
    ...
    getUserLatestVerificationStatus(userId) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const userVerifications = yield db_1.db
                    .select()
