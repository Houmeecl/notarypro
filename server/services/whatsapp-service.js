...
class WhatsappService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                if (this.provider === 'twilio') {
                    return yield this.sendViaTwilio(message);
                }
                else {
                    return yield this.sendVia360Dialog(message);
                }
            }
            catch (error) {
     ...
     * @returns ID externo del mensaje o null si hay error
     */
    sendTemplateMessage(phoneNumber_1, templateName_1) {
        return __awaiter(this, arguments, void 0, function* (phoneNumber, templateName, parameters = {}) {
            if (!this.apiKey || !this.apiUrl) {
                console.warn('WhatsApp API configuration is incomplete');
                return null;
            }
            try {
                ...
                if (this.provider === 'twilio') {
                    externalMessageId = yield this.sendTemplateViaTwilio(savedMessage, templateName, parameters);
                }
                else {
                    externalMessageId = yield this.sendTemplateVia360Dialog(savedMessage, templateName, parameters);
                }
    ...
    processWebhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (this.provider === 'twilio') {
                    return yield this.processTwilioWebhook(data);
                }
                else {
                    return yield this.process360DialogWebhook(data);
                }
            }
            catch (error) {
    ...
    sendViaTwilio(message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post(`${this.apiUrl}/Messages.json`, new URLSearchParams({
     ...
     */
    sendVia360Dialog(message) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield axios_1.default.post(`${this.apiUrl}/messages`, {
     ...
     */
    sendTemplateViaTwilio(message, templateName, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
     ...
     */
    sendTemplateVia360Dialog(message, templateName, parameters) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
    ...
    processTwilioWebhook(data) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const [message] = yield db_1.db.insert(schema_1.whatsappMessages)
                    .values({
                    direction: 'incoming',
                    phoneNumber,
                    messageType: 'text',
