...
function getIntegrationsStatus() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        for (const [id, integration] of Object.entries(integrations)) {
            result[id] = Object.assign({}, integration.status);
        }
 ...
 */
function saveIntegrationConfig(apiId, config) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
function testIntegrationConnection(apiId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!integrations[apiId]) {
            throw new Error(`Integración no encontrada: ${apiId}`);
        }
        ...
        try {
            ...
            switch (apiId) {
                ...
                case 'videox':
                    ...
                    const videoXResult = yield videox_service_1.videoXService.testConnection();
            ...
            return Object.assign({}, integrations[apiId].status);
        }
        catch (error) {
 ...
 */
function toggleIntegration(apiId, isEnabled) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!integrations[apiId]) {
            throw new Error(`Integración no encontrada: ${apiId}`);
        }
 ...
 */
function getIntegrationConfig(apiId) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!integrations[apiId]) {
            throw new Error(`Integración no encontrada: ${apiId}`);
        }
        // Por seguridad, no devolvemos las credenciales completas
        const result = Object.assign({}, integrations[apiId]);
