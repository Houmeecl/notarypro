 ...
 */
function verifyFacialSimilarity(selfiePath, documentPhotoPath) {
 ...
 */
function extractDocumentInfo(documentImagePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
 ...
 */
function analyzeDocumentAuthenticity(documentImagePath) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            // Convertir imagen a base64
            const documentBase64 = fs.readFileSync(documentImagePath, { encoding: 'base64' });
