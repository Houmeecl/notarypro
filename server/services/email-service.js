...
class EmailService {
    ...
    sendEmail(config) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield mailService.send(mailData);
     ...
     */
    sendPaymentConfirmation(email, documentTitle, documentId, paymentAmount, paymentId, userName) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    sendDocumentCopy(email, documentTitle, documentId, pdfBase64, pdfUrl) {
        return __awaiter(this, void 0, void 0, function* () {
     ...
     */
    sendDocumentStatusUpdate(email, documentTitle, documentId, status) {
        return __awaiter(this, void 0, void 0, function* () {
            let statusText = '';
            let subject = '';
            switch (status) {
